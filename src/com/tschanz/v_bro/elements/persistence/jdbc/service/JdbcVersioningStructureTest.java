...
import com.tschanz.v_bro.versioning_structure.domain.RepoClass;
import com.tschanz.v_bro.versioning_structure.domain.RepoFieldType;
import com.tschanz.v_bro.versioning_structure.domain.RepoRelation;
...
class JdbcVersioningStructureTest {
    private MockDatabaseMetaData mockDatabaseMetaData;
    private JdbcVersioningStructure jdbcVersioningStructure;
    ...
    void setUp() {
        ...
        this.jdbcVersioningStructure = new JdbcVersioningStructure(mockConnectionFactory);
    }
    ...
    void findTablesNamesBySuffix_happy_day() throws RepoException {
        ...
        List<String> tableNames = this.jdbcVersioningStructure.findElementClasses("TAB");
    ...
    void findTablesNamesBySuffix_sql_exception() {
        ...
        Exception exception = assertThrows(RepoException.class, () -> {
            this.jdbcVersioningStructure.findElementClasses("TAB");
        });
    ...
    void findTablesNamesBySuffix_escapes_underscore() throws RepoException {
        ...
        this.jdbcVersioningStructure.findElementClasses("TABLE1_E");
        ...
        Assertions.assertEquals(JdbcVersioningStructure.WILDCARD + "TABLE1$_E", this.mockDatabaseMetaData.mockHelper.getMethodArgument("getTables", 2));
    }
    ...
    void readTableStructure_minimal_table() throws RepoException {
        ...
        RepoClass result = this.jdbcVersioningStructure.readClass(tableName);
    ...
    void readTableStructure_sql_exception() {
        ...
        Exception exception = assertThrows(RepoException.class, () -> {
            this.jdbcVersioningStructure.readTable(tableName);
        });
    ...
    void readTable_happy_day() throws RepoException {
        ...
        String result = this.jdbcVersioningStructure.readTable(tableName);
    ...
    void readColumns_happy_day() throws RepoException {
        ...
        List<ColumnInfo> columnInfos = this.jdbcVersioningStructure.readFields(tableName);
    ...
    void readColumns_sql_exception() throws RepoException {
        ...
        Exception exception = assertThrows(RepoException.class, () -> {
            this.jdbcVersioningStructure.readFields(tableName);
        });
    ...
    void readPrimaryKeys_happy_day() throws RepoException {
        ...
        List<PkInfo> pkInfos = this.jdbcVersioningStructure.readPrimaryKeys(tableName);
    ...
    void readPrimaryKeys_sql_exception() throws RepoException {
        ...
        Exception exception = assertThrows(RepoException.class, () -> {
            this.jdbcVersioningStructure.readPrimaryKeys(tableName);
        });
    ...
    void readIndexes_outgoing() throws RepoException {
        ...
        List<IndexInfo> indexInfos = this.jdbcVersioningStructure.readIndexes("TABLE1_V", false);
    ...
    void readIndexes_no_results() throws RepoException {
        ...
        List<IndexInfo> indexInfos = this.jdbcVersioningStructure.readIndexes("TABLE1_V", true);
    ...
    void readIndexes_sql_exception() {
        ...
        Exception exception = assertThrows(RepoException.class, () -> {
            this.jdbcVersioningStructure.readIndexes("TABLE1_V", true);
        });
    ...
    void readRelations_incoming() throws RepoException {
        ...
        List<RepoRelation> repoRelations = this.jdbcVersioningStructure.readRelations("TABLE1_E", true);
    ...
    void readRelations_outgoing() throws RepoException {
        ...
        List<RepoRelation> repoRelations = this.jdbcVersioningStructure.readRelations("TABLE1_E", false);
    ...
    void readRelations_sql_exception() throws RepoException {
        ...
        Exception exception = assertThrows(RepoException.class, () -> {
            this.jdbcVersioningStructure.readRelations("TABLE1_E", true);
        });
