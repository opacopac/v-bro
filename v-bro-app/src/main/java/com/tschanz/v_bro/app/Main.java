...
import com.tschanz.v_bro.structure.persistence.jdbc.service.JdbcDependencyService;
import com.tschanz.v_bro.structure.persistence.mock.service.MockDependencyService;
import com.tschanz.v_bro.structure.persistence.xml.sax_parser.VersionAggregateParser;
import com.tschanz.v_bro.structure.persistence.xml.service.XmlDependencyService;
...
import com.tschanz.v_bro.structure.persistence.jdbc.service.JdbcElementClassService;
import com.tschanz.v_bro.structure.persistence.mock.service.MockElementClassService;
import com.tschanz.v_bro.structure.persistence.xml.service.XmlElementClassService;
...
import com.tschanz.v_bro.structure.persistence.mock.service.MockElementService;
import com.tschanz.v_bro.structure.persistence.jdbc.service.JdbcElementService;
import com.tschanz.v_bro.structure.persistence.xml.service.XmlElementService;
...
import com.tschanz.v_bro.structure.persistence.jdbc.service.JdbcVersionAggregateServiceCache;
import com.tschanz.v_bro.structure.persistence.mock.service.MockVersionAggregateService;
import com.tschanz.v_bro.structure.persistence.xml.service.XmlVersionAggregateService;
...
import com.tschanz.v_bro.structure.persistence.mock.service.MockVersionService;
import com.tschanz.v_bro.structure.persistence.xml.service.XmlVersionService;
import com.tschanz.v_bro.app.usecase.select_version.SelectVersionUseCase;
import com.tschanz.v_bro.structure.persistence.xml.stax_parser.DenominationsParser;
import com.tschanz.v_bro.structure.persistence.xml.stax_parser.ElementParser;
import com.tschanz.v_bro.structure.persistence.xml.stax_parser.VersionParser;
...
public class Main {
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        MockElementService mockElementService = new MockElementService();
        MockElementClassService mockElementClassService = new MockElementClassService();
        MockVersionService mockVersionDataService = new MockVersionService();
        MockVersionAggregateService mockVersionAggregateService = new MockVersionAggregateService();
        MockDependencyService mockDependencyService = new MockDependencyService();
